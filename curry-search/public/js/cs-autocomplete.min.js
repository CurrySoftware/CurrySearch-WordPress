...
$jscomp.polyfill("String.prototype.startsWith",function(e){return e?e:function(e,z){var q=$jscomp.checkStringArgs(this,e,"startsWith");e+="";var L=q.length,da=e.length;z=Math.max(0,Math.min(z|0,q.length));for(var ka=0;ka<da&&z<L;)if(q[z++]!=e[ka++])return!1;return ka>=da}},"es6","es3");
...
")"}if("_Task"===b)return"<task>";if("_Array"===a.ctor)return a=Fb(a),"Array.fromList "+d(a);if("<decoder>"===a.ctor)return"<decoder>";if("_Process"===a.ctor)return"<process:"+a.id+">";if("::"===a.ctor){b="["+d(a._0);for(a=a._1;"::"===a.ctor;)b+=","+d(a._0),a=a._1;return b+"]"}if("[]"===a.ctor)return"[]";if("Set_elm_builtin"===a.ctor)return"Set.fromList "+d(_elm_lang$core$Set$toList(a));if("RBNode_elm_builtin"===a.ctor||"RBEmpty_elm_builtin"===a.ctor)return"Dict.fromList "+d(va(a));b="";for(var l in a)if("ctor"!==
...
"\n\nThe message provided by the code author is:\n\n    "+k);}},toString:d}}();e(function(a,b){return g(a,b._0,b._1)});q(function(a,b,c){return a({ctor:"_Tuple2",_0:b,_1:c})});q(function(a,b,c){return g(a,c,b)});var Ea=e(function(a,b){return a}),r=r||{};r["<|"]=e(function(a,b){return a(b)});r=r||{};r["|>"]=e(function(a,b){return b(a)});r=r||{};r[">>"]=q(function(a,b,c){return b(a(c))});r=r||{};r["<<"]=q(function(a,b,c){return a(b(c))});r=r||{};r["++"]=p.append;var ma=p.toString;r=r||{};r["||"]=K.or;
r=r||{};r["&&"]=K.and;var Ta=K.compare;r=r||{};r[">="]=K.ge;r=r||{};r["<="]=K.le;r=r||{};r[">"]=K.gt;r=r||{};r["<"]=K.lt;r=r||{};r["/="]=K.neq;r=r||{};r["=="]=K.eq;r=r||{};r["^"]=K.exp;r=r||{};r["%"]=K.mod;r=r||{};r["//"]=K.div;r=r||{};r["/"]=K.floatDiv;r=r||{};r["*"]=K.mul;r=r||{};r["-"]=K.sub;r=r||{};r["+"]=K.add;var Gb=e(function(a,b){return"Just"===b.ctor?b._0:a}),J={ctor:"Nothing"};e(function(a,b){return"Just"===b.ctor?a(b._0):J});var M=function(a){return{ctor:"Just",_0:a}};e(function(a,b){return"Just"===
...
d){return p.cmp(a(b),a(d))}))}),sortWith:e(function(a,d){return b(c(d).sort(function(b,d){b=a(b)(d).ctor;return"EQ"===b?0:"LT"===b?-1:1}))})}}(),Hb=e(function(a,b){for(;;){if(1>p.cmp(a,0))return b;var c=b;if("[]"===c.ctor)return b;b=c._1;--a}}),Ib=D.map2,Ua=e(function(a,b){for(;;){if("[]"===b.ctor)return!1;if(a(b._0))return!0;b=b._1}});e(function(a,b){return!g(Ua,function(b){return!a(b)},b)});var ba=D.foldr,na=q(function(a,b,c){for(;;){var d=c;if("[]"===d.ctor)return b;c=a;b=g(a,d._0,b);d=d._1;a=
c;c=d}}),Jb=function(a){return n(na,e(function(a,c){return c+1}),0,a)};e(function(a,b){return g(Ua,function(b){return p.eq(b,a)},b)});var Va=Va||{};Va["::"]=D.cons;var wa=e(function(a,b){return n(ba,e(function(b,d){return{ctor:"::",_0:a(b),_1:d}}),{ctor:"[]"},b)});e(function(a,b){var c=e(function(b,c){return a(b)?{ctor:"::",_0:b,_1:c}:c});return n(ba,c,{ctor:"[]"},b)});var Kb=q(function(a,b,c){a=a(b);return"Just"===a.ctor?{ctor:"::",_0:a._0,_1:c}:c});e(function(a,b){return n(ba,Kb(a),{ctor:"[]"},
b)});var Wa=function(a){return n(na,e(function(a,c){return{ctor:"::",_0:a,_1:c}}),{ctor:"[]"},a)};q(function(a,b,c){var d=e(function(b,d){return"::"===d.ctor?{ctor:"::",_0:g(a,b,d._0),_1:d}:{ctor:"[]"}});return Wa(n(na,d,{ctor:"::",_0:b,_1:{ctor:"[]"}},c))});var Lb=e(function(a,b){return"[]"===b.ctor?a:n(ba,e(function(a,b){return{ctor:"::",_0:a,_1:b}}),b,a)});e(function(a,b){return n(ba,Lb,{ctor:"[]"},g(wa,a,b))});e(function(a,b){var c=e(function(b,c){var d=c._0;c=c._1;return a(b)?{ctor:"_Tuple2",
_0:{ctor:"::",_0:b,_1:d},_1:c}:{ctor:"_Tuple2",_0:d,_1:{ctor:"::",_0:b,_1:c}}});return n(ba,c,{ctor:"_Tuple2",_0:{ctor:"[]"},_1:{ctor:"[]"}},b)});e(function(a,b){if("[]"===b.ctor)return{ctor:"[]"};var c=e(function(b,c){return{ctor:"::",_0:a,_1:{ctor:"::",_0:b,_1:c}}});c=n(ba,c,{ctor:"[]"},b._1);return{ctor:"::",_0:b._0,_1:c}});var Mb=q(function(a,b,c){for(;;){if(1>p.cmp(a,0))return c;var d=b;if("[]"===d.ctor)return c;b=d._1;c={ctor:"::",_0:d._0,_1:c};--a}}),Nb=e(function(a,b){return Wa(n(Mb,a,b,{ctor:"[]"}))}),
Xa=q(function(a,b,c){if(1>p.cmp(b,0))return{ctor:"[]"};a:do{b:do{if("[]"===c.ctor)return c;if("::"===c._1.ctor)switch(b){case 1:break b;case 2:return{ctor:"::",_0:c._0,_1:{ctor:"::",_0:c._1._0,_1:{ctor:"[]"}}};case 3:if("::"===c._1._1.ctor)return{ctor:"::",_0:c._0,_1:{ctor:"::",_0:c._1._0,_1:{ctor:"::",_0:c._1._1._0,_1:{ctor:"[]"}}}};break a;default:if("::"===c._1._1.ctor&&"::"===c._1._1._1.ctor){var d=c._1._1._0,f=c._1._0,e=c._0,h=c._1._1._1._0;c=c._1._1._1._1;return 0<p.cmp(a,1E3)?{ctor:"::",_0:e,
_1:{ctor:"::",_0:f,_1:{ctor:"::",_0:d,_1:{ctor:"::",_0:h,_1:g(Nb,b-4,c)}}}}:{ctor:"::",_0:e,_1:{ctor:"::",_0:f,_1:{ctor:"::",_0:d,_1:{ctor:"::",_0:h,_1:n(Xa,a+1,b-4,c)}}}}}break a}else if(1===b)break b;else break a}while(0);return{ctor:"::",_0:c._0,_1:{ctor:"[]"}}}while(0);return c});e(function(a,b){return n(Xa,0,a,b)});var Ob=q(function(a,b,c){for(;;){if(1>p.cmp(b,0))return a;--b;var d=c;a={ctor:"::",_0:c,_1:a};c=d}});e(function(a,b){return n(Ob,{ctor:"[]"},a,b)});var Pb=q(function(a,b,c){for(;;)if(1>
p.cmp(a,b))c={ctor:"::",_0:b,_1:c},--b;else return c}),Qb=e(function(a,b){return n(Pb,a,b,{ctor:"[]"})}),Rb=e(function(a,b){return n(Ib,a,g(Qb,0,Jb(b)-1),b)});e(function(a,b){return 1>p.cmp(0,a)&&0>p.cmp(a,S.length(b))?M(g(S.get,a,b)):J});e(function(a,b){var c=e(function(b,c){return a(b)?g(S.push,b,c):c});return n(S.foldl,c,S.empty,b)});var Fb=S.toList,Sb=S.initialize;e(function(a,b){return g(Sb,a,Ea(b))});var oa=function(){return{crash:function(a){throw Error(a);},log:e(function(a,b){a=a+": "+p.toString(b);
var c=c||{};c.stdout?c.stdout.write(a):console.log(a);return b})}}(),Tb=function(){function a(a,b){for(var d="";0<a;)a&1&&(d+=b),a>>=1,b+=b;return d}function b(a){return C("could not convert string '"+a+"' to an Int")}function c(a){return C("could not convert string '"+a+"' to a Float")}return{isEmpty:function(a){return 0===a.length},cons:e(function(a,b){return a+b}),uncons:function(a){var b=a[0];return b?M(p.Tuple2(p.chr(b),a.slice(1))):J},append:e(function(a,b){return a+b}),concat:function(a){return D.toArray(a).join("")},
...
b.indexOf(a)}),startsWith:e(function(a,b){return 0===b.indexOf(a)}),endsWith:e(function(a,b){return b.length>=a.length&&b.lastIndexOf(a)===b.length-a.length}),indexes:e(function(a,b){var d=a.length;if(1>d)return D.Nil;for(var c=0,f=[];-1<(c=b.indexOf(a,c));)f.push(c),c+=d;return D.fromArray(f)}),toInt:function(a){var d=a.length;if(0===d)return b(a);var c=a[0];if("0"===c&&"x"===a[1]){for(var e=2;e<d;++e)if(c=a[e],!("0"<=c&&"9">=c||"A"<=c&&"F">=c||"a"<=c&&"f">=c))return b(a);return P(parseInt(a,16))}if("9"<
c||"0">c&&"-"!==c&&"+"!==c)return b(a);for(e=1;e<d;++e)if(c=a[e],"0">c||"9"<c)return b(a);return P(parseInt(a,10))},toFloat:function(a){if(0===a.length||/[\sxbo]/.test(a))return c(a);var b=+a;return b===b?P(b):c(a)},toList:function(a){return D.fromArray(a.split("").map(p.chr))},fromList:function(a){return D.toArray(a).join("")}}}(),Fa=function(){return{fromCode:function(a){return p.chr(String.fromCharCode(a))},toCode:function(a){return a.charCodeAt(0)},toUpper:function(a){return p.chr(a.toUpperCase())},
...
C(b._0)});var P=function(a){return{ctor:"Ok",_0:a}},Ub=e(function(a,b){return"Ok"===b.ctor?P(a(b._0)):C(b._0)});q(function(a,b,c){return"Ok"===b.ctor?"Ok"===c.ctor?P(g(a,b._0,c._0)):C(c._0):C(b._0)});z(function(a,b,c,d){return"Ok"===b.ctor?"Ok"===c.ctor?"Ok"===d.ctor?P(n(a,b._0,c._0,d._0)):C(d._0):C(c._0):C(b._0)});G(function(a,b,c,d,e){return"Ok"===b.ctor?"Ok"===c.ctor?"Ok"===d.ctor?"Ok"===e.ctor?P(Y(a,b._0,c._0,d._0,e._0)):C(e._0):C(d._0):C(c._0):C(b._0)});L(function(a,b,c,d,e,g){return"Ok"===b.ctor?
"Ok"===c.ctor?"Ok"===d.ctor?"Ok"===e.ctor?"Ok"===g.ctor?P(w(a,b._0,c._0,d._0,e._0,g._0)):C(g._0):C(e._0):C(d._0):C(c._0):C(b._0)});e(function(a,b){return"Ok"===b.ctor?P(b._0):C(a(b._0))});e(function(a,b){return"Just"===b.ctor?P(b._0):C(a)});var Vb=Tb.concat,Ya=q(function(a,b,c){for(;;){var d=c;if("RBEmpty_elm_builtin"===d.ctor)return b;c=a;b=n(a,d._1,d._2,n(Ya,a,b,d._4));d=d._3;a=c;c=d}}),va=function(a){return n(Ya,q(function(a,c,d){return{ctor:"::",_0:{ctor:"_Tuple2",_0:a,_1:c},_1:d}}),{ctor:"[]"},
a)},fa=q(function(a,b,c){for(;;){var d=c;if("RBEmpty_elm_builtin"===d.ctor)return b;c=a;b=n(a,d._1,d._2,n(fa,a,b,d._3));d=d._4;a=c;c=d}}),Wb=L(function(a,b,c,d,f,g){var t=q(function(d,e,k){for(;;){var l=k;k=l._1;var f=l._0,g=f;if("[]"===g.ctor)return{ctor:"_Tuple2",_0:f,_1:n(c,d,e,k)};l=g._1;var t=g._0._1;g=g._0._0;if(0>p.cmp(g,d))k={ctor:"_Tuple2",_0:l,_1:n(a,g,t,k)};else return 0<p.cmp(g,d)?{ctor:"_Tuple2",_0:f,_1:n(c,d,e,k)}:{ctor:"_Tuple2",_0:l,_1:Y(b,g,t,e,k)}}});f=n(fa,t,{ctor:"_Tuple2",_0:va(d),
_1:g},f);d=f._0;f=f._1;return n(na,e(function(b,d){return n(a,b._0,b._1,d)}),f,d)}),Za=z(function(a,b,c,d){return oa.crash(Vb({ctor:"::",_0:"Internal red-black tree invariant violated, expected ",_1:{ctor:"::",_0:a,_1:{ctor:"::",_0:" and got ",_1:{ctor:"::",_0:ma(b),_1:{ctor:"::",_0:"/",_1:{ctor:"::",_0:c,_1:{ctor:"::",_0:"/",_1:{ctor:"::",_0:d,_1:{ctor:"::",_0:"\nPlease report this bug to <https://github.com/elm-lang/core/issues>",_1:{ctor:"[]"}}}}}}}}}}))}),$a=function(a){a:do{if("RBNode_elm_builtin"===
a.ctor){if("BBlack"===a._0.ctor)return!0}else if("LBBlack"===a._0.ctor)return!0;break a}while(0);return!1},Xb=e(function(a,b){for(;;){if("RBEmpty_elm_builtin"===b.ctor)return a;a=g(Xb,a+1,b._4);b=b._3}}),Ga=e(function(a,b){a:for(;;){if("RBEmpty_elm_builtin"===b.ctor)return J;switch(g(Ta,a,b._1).ctor){case "LT":b=b._3;continue a;case "EQ":return M(b._2);default:b=b._4}}}),Yb=e(function(a,b){return"Just"===g(Ga,a,b).ctor?!0:!1}),Zb=q(function(a,b,c){for(;;){if("RBEmpty_elm_builtin"===c.ctor)return{ctor:"_Tuple2",
_0:a,_1:b};b=c._2;var d=c._4;a=c._1;c=d}}),$b={ctor:"NBlack"},ab={ctor:"BBlack"},N={ctor:"Black"},ya={ctor:"Red"},ac=function(a){switch(a.ctor){case "Black":return ab;case "Red":return N;case "NBlack":return ya;default:return oa.crash("Can't make a double black node more black!")}},bb=function(a){switch(a.ctor){case "BBlack":return N;case "Black":return ya;case "Red":return $b;default:return oa.crash("Can't make a negative black node less black!")}},bc={ctor:"LBBlack"},pa={ctor:"LBlack"},ha=function(a){return{ctor:"RBEmpty_elm_builtin",
_0:a}},Q=ha(pa),E=G(function(a,b,c,d,e){return{ctor:"RBNode_elm_builtin",_0:a,_1:b,_2:c,_3:d,_4:e}}),cc=function(a){return"RBNode_elm_builtin"===a.ctor&&"Red"===a._0.ctor?w(E,N,a._1,a._2,a._3,a._4):a},cb=function(a){return"RBNode_elm_builtin"===a.ctor?w(E,bb(a._0),a._1,a._2,a._3,a._4):ha(pa)},za=function(a){return function(b){return function(c){return function(d){return function(e){return function(f){return function(g){return function(t){return function(u){return function(k){return function(l){return w(E,
bb(a),d,e,w(E,N,b,c,t,u),w(E,N,f,g,k,l))}}}}}}}}}}},dc=function(a){return"RBEmpty_elm_builtin"===a.ctor?ha(pa):w(E,N,a._1,a._2,a._3,a._4)},db=function(a){return"RBEmpty_elm_builtin"===a.ctor?oa.crash("can't make a Leaf red"):w(E,ya,a._1,a._2,a._3,a._4)},ec=function(a){a:do{b:do{c:do{d:do{e:do{f:do{g:do if("RBNode_elm_builtin"===a.ctor)if("RBNode_elm_builtin"===a._3.ctor)if("RBNode_elm_builtin"===a._4.ctor)switch(a._3._0.ctor){case "Red":switch(a._4._0.ctor){case "Red":if("RBNode_elm_builtin"===a._3._3.ctor&&
...
return za(a._0)(a._1)(a._2)(a._4._3._1)(a._4._3._2)(a._4._1)(a._4._2)(a._3)(a._4._3._3)(a._4._3._4)(a._4._4)}while(0);return za(a._0)(a._1)(a._2)(a._4._1)(a._4._2)(a._4._4._1)(a._4._4._2)(a._3)(a._4._3)(a._4._4._3)(a._4._4._4)}while(0);return w(E,N,a._4._3._1,a._4._3._2,w(E,N,a._1,a._2,a._3,a._4._3._3),w(qa,N,a._4._1,a._4._2,a._4._3._4,db(a._4._4)))}while(0);return w(E,N,a._3._4._1,a._3._4._2,w(qa,N,a._3._1,a._3._2,db(a._3._3),a._3._4._3),w(E,N,a._1,a._2,a._3._4._4,a._4))}while(0);return a},qa=G(function(a,
b,c,d,e){a=w(E,a,b,c,d,e);"RBNode_elm_builtin"===a.ctor?(b=a._0,b=p.eq(b,N)||p.eq(b,ab)):b=!0;return b?ec(a):a}),Aa=G(function(a,b,c,d,e){return $a(d)||$a(e)?w(qa,ac(a),b,c,cb(d),cb(e)):w(E,a,b,c,d,e)}),fb=G(function(a,b,c,d,e){return"RBEmpty_elm_builtin"===e.ctor?n(eb,a,d,e):w(Aa,a,b,c,d,w(fb,e._0,e._1,e._2,e._3,e._4))}),eb=q(function(a,b,c){if("RBEmpty_elm_builtin"===b.ctor)if("RBEmpty_elm_builtin"===c.ctor)switch(a.ctor){case "Red":return ha(pa);case "Black":return ha(bc);default:return oa.crash("cannot have bblack or nblack nodes at this point")}else{var d=
c._0;b=b._0;return"Black"===a.ctor&&"LBlack"===b.ctor&&"Red"===d.ctor?w(E,N,c._1,c._2,c._3,c._4):Y(Za,"Black/LBlack/Red",a,ma(b),ma(d))}else{if("RBEmpty_elm_builtin"===c.ctor)return c=c._0,d=b._0,"Black"===a.ctor&&"Red"===d.ctor&&"LBlack"===c.ctor?w(E,N,b._1,b._2,b._3,b._4):Y(Za,"Black/Red/LBlack",a,ma(d),ma(c));d=b._2;var e=b._4,g=b._1;b=w(fb,b._0,g,d,b._3,e);d=n(Zb,g,d,e);return w(Aa,a,d._0,d._1,b,c)}}),gb=e(function(a,b){if("RBEmpty_elm_builtin"===b.ctor)return ha(pa);var c=b._1;return w(E,b._0,
c,g(a,c,b._2),g(gb,a,b._3),g(gb,a,b._4))}),Ba={ctor:"Same"},Ha={ctor:"Remove"},Ia={ctor:"Insert"},Ja=q(function(a,b,c){var d=function(c){if("RBEmpty_elm_builtin"===c.ctor){var e=b(J);return"Nothing"===e.ctor?{ctor:"_Tuple2",_0:Ba,_1:Q}:{ctor:"_Tuple2",_0:Ia,_1:w(E,ya,a,e._0,Q,Q)}}var f=c._2,t=c._4,k=c._3;e=c._1;c=c._0;switch(g(Ta,a,e).ctor){case "EQ":return f=b(M(f)),"Nothing"===f.ctor?{ctor:"_Tuple2",_0:Ha,_1:n(eb,c,k,t)}:{ctor:"_Tuple2",_0:Ba,_1:w(E,c,e,f._0,k,t)};case "LT":k=d(k);var l=k._0;k=
k._1;switch(l.ctor){case "Same":return{ctor:"_Tuple2",_0:Ba,_1:w(E,c,e,f,k,t)};case "Insert":return{ctor:"_Tuple2",_0:Ia,_1:w(qa,c,e,f,k,t)};default:return{ctor:"_Tuple2",_0:Ha,_1:w(Aa,c,e,f,k,t)}}default:switch(t=d(t),l=t._0,t=t._1,l.ctor){case "Same":return{ctor:"_Tuple2",_0:Ba,_1:w(E,c,e,f,k,t)};case "Insert":return{ctor:"_Tuple2",_0:Ia,_1:w(qa,c,e,f,k,t)};default:return{ctor:"_Tuple2",_0:Ha,_1:w(Aa,c,e,f,k,t)}}}};c=d(c);var e=c._1;switch(c._0.ctor){case "Same":return e;case "Insert":return cc(e);
default:return dc(e)}}),W=q(function(a,b,c){return n(Ja,a,Ea(M(b)),c)});e(function(a,b){return n(W,a,b,Q)});e(function(a,b){return n(fa,W,b,a)});var fc=e(function(a,b){var c=q(function(b,c,e){return g(a,b,c)?n(W,b,c,e):e});return n(fa,c,Q,b)});e(function(a,b){return g(fc,e(function(a,d){return g(Yb,a,b)}),a)});e(function(a,b){var c=q(function(b,c,e){var d=e._1;e=e._0;return g(a,b,c)?{ctor:"_Tuple2",_0:n(W,b,c,e),_1:d}:{ctor:"_Tuple2",_0:e,_1:n(W,b,c,d)}});return n(fa,c,{ctor:"_Tuple2",_0:Q,_1:Q},
b)});var gc=e(function(a,b){return n(Ja,a,Ea(J),b)});e(function(a,b){return n(fa,q(function(a,b,e){return g(gc,a,e)}),a,b)});var H=function(){function a(a,b){return{ctor:"<decoder>",tag:"map-many",func:a,decoders:b}}function b(a){return{tag:"ok",value:a}}function c(a,b){return{tag:"primitive",type:a,value:b}}function d(a,b){return{tag:"index",index:a,rest:b}}function d(a,b){return{tag:"index",index:a,rest:b}}function f(a){for(var b="_";a;)switch(a.tag){case "primitive":return b="Expecting "+a.type+
("_"===b?"":" at "+b)+" but instead got: ",a=a.value,a=void 0===a?"undefined":JSON.stringify(a),b+a;case "index":b+="["+a.index+"]";a=a.rest;break;case "field":b+="."+a.field;a=a.rest;break;case "oneOf":a=a.problems;for(var c=0;c<a.length;c++)a[c]=f(a[c]);return"I ran into the following problems"+("_"===b?"":" at "+b)+":\n\n"+a.join("\n");case "fail":return"I ran into a `fail` decoder"+("_"===b?"":" at "+b)+": "+a.msg}}function g(a,b){a=h(a,b);return"ok"===a.tag?P(a.value):C(f(a))}function h(a,e){switch(a.tag){case "bool":return"boolean"===
...
a.ctor;){var c=a._0;b[c._0]=c._1;a=a._1}return b},equality:u}}(),hc=H.encodeObject,ic=H.identity,jc=H.identity,hb=H.identity,kc=H.encode;H.decodePrimitive("value");var Ka=H.andThen,ib=H.succeed,lc=H.run,mc=H.runOnString,nc=H.map1,ra=H.decodeField,jb=e(function(a,b){return n(ba,ra,b,a)});H.decodePrimitive("float");var kb=H.decodePrimitive("int"),oc=H.decodePrimitive("bool"),ia=H.decodePrimitive("string"),ja=function(){function a(a,b,c){return{type:"thunk",func:a,args:b,thunk:c,node:void 0}}function b(a){for(var b,
...
typeof c){for(var g=I.createDocumentFragment(),k=0;k<c.length;k++){var l=c[k].entry;g.appendChild("move"===l.tag?l.data:d(l.vnode,b.eventNode))}c=g}else c=void 0;a=C(a,e.patches);e=e.inserts;for(g=0;g<e.length;g++)k=e[g],l=k.entry,l="move"===l.tag?l.data:d(l.vnode,b.eventNode),a.insertBefore(l,a.childNodes[k.index]);"undefined"!==typeof c&&a.appendChild(c);return a;case "p-custom":return b=b.data,b.applyPatch(a,b.data);default:throw Error("Ran into an unknown patch!");}}function V(a){return e(function(b,
c){return function(d){return function(e,f,k){var l=a(d,f);"undefined"===typeof k?ea(c,e,f,l):B(g(b,k,c),e,f,l)}}})}function A(a,b){b&&(b.innerHTML='<div style="padding-left:1em;"><h2 style="font-weight:normal;"><b>Oops!</b> Something went wrong when starting your Elm program.</h2><pre style="padding-left:1em;">'+a+"</pre></div>");throw Error(a);}function ea(a,b,c,d){b.embed=function(b,c){for(;b.lastChild;)b.removeChild(b.lastChild);return R.initialize(d(a.init,c,b),a.update,a.subscriptions,U(b,a.view))};
b.fullscreen=function(b){return R.initialize(d(a.init,b,document.body),a.update,a.subscriptions,U(document.body,a.view))}}function U(a,b){return function(c,e){c={tagger:c,parent:void 0};e=b(e);var f=d(e,c);a.appendChild(f);return F(f,b,e,c)}}function F(a,b,c,d){function e(){switch(f){case "NO_REQUEST":throw Error("Unexpected draw callback.\nPlease report this to <https://github.com/elm-lang/virtual-dom/issues>.");case "PENDING_REQUEST":Q(e);f="EXTRA_REQUEST";var c=b(k),l=r(g,c);a=D(a,g,l,d);g=c;break;
case "EXTRA_REQUEST":f="NO_REQUEST"}}var f="NO_REQUEST",g=c,k;return function(a){"NO_REQUEST"===f&&Q(e);f="PENDING_REQUEST";k=a}}function B(a,b,c,d){b.fullscreen=function(b){var e={doc:void 0};return R.initialize(d(a.init,b,document.body),a.update(Ra(e)),a.subscriptions,E(c,document.body,e,a.view,a.viewIn,a.viewOut))};b.embed=function(b,e){var f={doc:void 0};return R.initialize(d(a.init,e,b),a.update(Ra(f)),a.subscriptions,E(c,b,f,a.view,a.viewIn,a.viewOut))}}function Ra(a){return y.nativeBinding(function(b){var c=
a.doc;c&&(c=c.getElementsByClassName("debugger-sidebar-messages")[0])&&(c.scrollTop=c.scrollHeight);b(y.succeed(p.Tuple0))})}function E(a,b,c,e,f,g){return function(k,l){var h={tagger:k,parent:void 0};k={tagger:k,parent:void 0};var m=e(l),v=d(m,h);b.appendChild(v);var t=F(v,e,m,h);m=f(l)._1;v=d(m,k);b.appendChild(v);h=ua(h,v,f);var u=F(v,h,m,k),A=J(l,g,k,b,a,c);return function(a){t(a);u(a);A(a)}}}function J(a,b,c,d,e,f){var g,k;return function(a){if(a.isDebuggerOpen)if(f.doc){I=f.doc;a=b(a);var d=
...
(e.tagger({ctor:"Down"}),a.preventDefault())});window.addEventListener("unload",f);g.addEventListener("unload",function(){b.doc=void 0;window.removeEventListener("unload",f);e.tagger({ctor:"Close"})});I=document;return a}function ua(a,b,c){var d=O(b),e="Normal",f,g=a.tagger,k=function(){};return function(b){b=c(b);var l=b._0.ctor;a.tagger="Normal"===l?g:k;e!==l&&(la("removeEventListener",d,e),la("addEventListener",d,l),"Normal"===e&&(f=document.body.style.overflow,document.body.style.overflow="hidden"),
...
0)}}),on:q(c),style:function(a){return{key:"STYLE",value:a}},property:e(function(a,b){return{key:a,value:b}}),attribute:e(function(a,b){return{key:"ATTR",realKey:a,value:b}}),attributeNS:q(function(a,b,c){return{key:"ATTR_NS",realKey:b,value:{value:c,namespace:a}}}),mapProperty:e(function(a,b){return"EVENT"!==b.key?b:c(b.realKey,b.value.options,g(nc,a,b.value.decoder))}),lazy:e(function(b,c){return a(b,[c],function(){return b(c)})}),lazy2:q(function(b,c,d){return a(b,[c,d],function(){return g(b,c,
d)})}),lazy3:z(function(b,c,d,e){return a(b,[c,d,e],function(){return n(b,c,d,e)})}),keyedNode:q(function(a,c,d){var e=b(c);c=e.namespace;e=e.facts;for(var f=[],g=0;"[]"!==d.ctor;){var k=d._0;g+=k._1.descendantsCount||0;f.push(k);d=d._1}g+=f.length;return{type:"keyed-node",tag:a,facts:e,children:f,namespace:c,descendantsCount:g}}),program:N,programWithFlags:P,staticProgram:function(a){var b=p.Tuple2(p.Tuple0,sa);return g(N,void 0,{init:b,view:function(){return a},update:e(function(){return b}),subscriptions:function(){return pc}})()}}}();
e(function(a,b){return{ctor:"_Tuple2",_0:b._0,_1:a(b._1)}});e(function(a,b){return{ctor:"_Tuple2",_0:a(b._0),_1:b._1}});var R=function(){function a(a,b){return function(a){}}function b(a,b,d,e){function k(a){y.rawSend(A,a)}var l={},h,t=y.nativeBinding(function(b){var c=a._0;h=e(k,c);var f=a._1,g=d(c);u(l,f,g);b(y.succeed(c))}),A=f(t,function(a,c){return y.nativeBinding(function(e){var f=g(b,a,c);c=f._0;h(c);f=f._1;var k=d(c);u(l,f,k);e(y.succeed(c))})});return(t=c(l,k))?{ports:t}:{}}function c(a,
...
unsubscribe:function(a){b=b.slice();a=b.indexOf(a);0<=a&&b.splice(a,1)}}}function z(a,b){function c(a,b,c){f=b;return t}function d(a){for(var c=f;"[]"!==c.ctor;)b(c._0(a)),c=c._1}var e=[],f=D.Nil,k=x[a].converter,l=function(a,b,f){a=c(a,b,f);for(b=0;b<e.length;b++)d(e[b]);e=null;h=d;l=c;return a},h=function(a){e.push(a)},t=y.succeed(null);x[a].init=t;x[a].onEffects=q(function(a,b,c){return l(a,b,c)});return{send:function(b){b=g(lc,k,b);if("Err"===b.ctor)throw Error("Trying to send an unexpected type of value through port `"+
...
e);b(a(p.Tuple0))})}),rawSpawn:c,rawSend:d}}(),lb=R.batch,sa=lb({ctor:"[]"}),mb=mb||{};mb["!"]=e(function(a,b){return{ctor:"_Tuple2",_0:a,_1:lb(b)}});var nb=R.batch,pc=nb({ctor:"[]"}),qc=R.sendToSelf,ob=R.sendToApp,pb={stopPropagation:!1,preventDefault:!1},rc=ja.on,sc=e(function(a,b){return n(rc,a,pb,b)}),qb=ja.property,La=ja.text,h=ja.node;e(function(a,b){return{stopPropagation:a,preventDefault:b}});h("body");h("section");h("nav");h("article");h("aside");h("h1");h("h2");h("h3");h("h4");h("h5");h("h6");
h("header");h("footer");h("address");h("main");h("p");h("hr");h("pre");h("blockquote");h("ol");var tc=h("ul"),rb=h("li");h("dl");h("dt");h("dd");h("figure");h("figcaption");h("div");h("a");h("em");h("strong");h("small");h("s");h("cite");h("q");h("dfn");h("abbr");h("time");h("code");h("var");h("samp");h("kbd");h("sub");h("sup");h("i");h("b");h("u");h("mark");h("ruby");h("rt");h("rp");h("bdi");h("bdo");h("span");h("br");h("wbr");h("ins");h("del");h("img");h("iframe");h("embed");h("object");h("param");
h("video");h("audio");h("source");h("track");h("canvas");h("math");h("table");h("caption");h("colgroup");h("col");h("tbody");h("thead");h("tfoot");h("tr");h("td");h("th");h("form");h("fieldset");h("legend");h("label");h("input");h("button");h("select");h("datalist");h("optgroup");h("option");h("textarea");h("keygen");h("output");h("progress");h("meter");h("details");h("summary");h("menuitem");h("menu");var uc=e(function(a,b){return g(qb,a,hb(b))});e(function(a,b){return g(qb,a,ic(b))});g(ra,"keyCode",
kb);g(jb,{ctor:"::",_0:"target",_1:{ctor:"::",_0:"checked",_1:{ctor:"[]"}}},oc);g(jb,{ctor:"::",_0:"target",_1:{ctor:"::",_0:"value",_1:{ctor:"[]"}}},ia);p.update(pb,{preventDefault:!0});e(function(a,b){return{stopPropagation:a,preventDefault:b}});var Ma=function(){function a(a,b){"Nothing"!==b.ctor&&a.addEventListener("progress",function(a){a.lengthComputable&&y.rawSpawn(b._0({bytes:a.loaded,bytesExpected:a.total}))})}function b(a,b){g(wa,function(b){a.setRequestHeader(b._0,b._1)},b.headers);a.responseType=
b.expect.responseType;a.withCredentials=b.withCredentials;"Just"===b.timeout.ctor&&(a.timeout=b.timeout._0)}function c(a,b){switch(b.ctor){case "EmptyBody":a.send();break;case "StringBody":a.setRequestHeader("Content-Type",b._0);a.send(b._1);break;case "FormDataBody":a.send(b._0)}}function d(a){var b=Q;if(!a)return b;a=a.split("\r\n");for(var c=a.length;c--;){var d=a[c],e=d.indexOf(": ");if(0<e){var f=d.substring(0,e),g=d.substring(e+2);b=n(Ja,f,function(a){return"Just"===a.ctor?M(g+", "+a._0):M(g)},
...
_0:b})):(a=a(b),"Ok"===a.ctor?b=y.succeed(a._0):(b.body=h.responseText,b=y.fail({ctor:"BadPayload",_0:a._0,_1:b})));f(b)});try{h.open(e.method,e.url,!0)}catch(Da){return f(y.fail({ctor:"BadUrl",_0:e.url}))}b(h,e);c(h,e.body);return function(){h.abort()}})}),expectStringResponse:function(a){return{responseType:"text",responseToResult:a}},mapExpect:e(function(a,b){return{responseType:b.responseType,responseToResult:function(c){c=b.responseToResult(c);return g(Ub,a,c)}}}),multipart:function(a){for(var b=
new FormData;"[]"!==a.ctor;){var c=a._0;b.append(c._0,c._1);a=a._1}return{ctor:"FormDataBody",_0:b}},encodeUri:function(a){return encodeURIComponent(a)},decodeUri:function(a){try{return M(decodeURIComponent(a))}catch(t){return J}}}}(),sb=function(){return{now:y.nativeBinding(function(a){a(y.succeed(Date.now()))}),setInterval_:e(function(a,b){return y.nativeBinding(function(c){var d=setInterval(function(){y.rawSpawn(b)},a);return function(){clearInterval(d)}})})}}(),tb=y.onError,x=y.andThen,vc=e(function(a,
b){return y.spawn(g(x,ob(a),b._0))}),wc=y.fail;e(function(a,b){return g(tb,function(b){return wc(a(b))},b)});var O=y.succeed,Na=e(function(a,b){return g(x,function(b){return O(a(b))},b)}),xc=q(function(a,b,c){return g(x,function(b){return g(x,function(c){return O(g(a,b,c))},c)},b)});z(function(a,b,c,d){return g(x,function(b){return g(x,function(c){return g(x,function(d){return O(n(a,b,c,d))},d)},c)},b)});G(function(a,b,c,d,e){return g(x,function(b){return g(x,function(c){return g(x,function(d){return g(x,
function(e){return O(Y(a,b,c,d,e))},e)},d)},c)},b)});L(function(a,b,c,d,e,h){return g(x,function(b){return g(x,function(c){return g(x,function(d){return g(x,function(e){return g(x,function(f){return O(w(a,b,c,d,e,f))},h)},e)},d)},c)},b)});var Oa=function(a){return"[]"===a.ctor?O({ctor:"[]"}):n(xc,e(function(a,c){return{ctor:"::",_0:a,_1:c}}),a._0,Oa(a._1))},yc=q(function(a,b,c){return g(Na,function(a){return{ctor:"_Tuple0"}},Oa(g(wa,vc(a),b)))}),zc=O({ctor:"_Tuple0"}),Ac=q(function(a,b,c){return O({ctor:"_Tuple0"})}),
ub=R.leaf("Task"),Bc=e(function(a,b){return ub({ctor:"Perform",_0:g(Na,a,b)})}),Cc=e(function(a,b){return ub({ctor:"Perform",_0:g(tb,function(b){return O(a(C(b)))},g(x,function(b){return O(a(P(b)))},b))})}),Dc=e(function(a,b){return{ctor:"Perform",_0:g(Na,a,b._0)}});R.effectManagers.Task={pkg:"elm-lang/core",init:zc,onEffects:yc,onSelfMsg:Ac,tag:"cmd",cmdMap:Dc};var Ec=sb.setInterval_,vb=q(function(a,b,c){if("[]"===b.ctor)return O(c);var d=b._0,e=y.spawn(g(Ec,d,g(qc,a,d)));return g(x,function(e){return n(vb,
a,b._1,n(W,d,e,c))},e)}),Fc=e(function(a,b){var c=a._1;a=a._0;var d=g(Ga,a,b);return"Nothing"===d.ctor?n(W,a,{ctor:"::",_0:c,_1:{ctor:"[]"}},b):n(W,a,{ctor:"::",_0:c,_1:d._0},b)}),Gc=sb.now,Hc=q(function(a,b,c){var d=g(Ga,b,c.taggers);return"Nothing"===d.ctor?O(c):g(x,function(a){return O(c)},g(x,function(b){return Oa(g(wa,function(c){return g(ob,a,c(b))},d._0))},Gc))}),Ic=R.leaf("Time"),wb=e(function(a,b){return{taggers:a,processes:b}}),Jc=O(g(wb,Q,Q)),Kc=q(function(a,b,c){var d=q(function(a,b,c){return{ctor:"_Tuple3",
_0:c._0,_1:c._1,_2:g(x,function(a){return c._2},y.kill(b))}}),e=z(function(a,b,c,d){return{ctor:"_Tuple3",_0:d._0,_1:n(W,a,c,d._1),_2:d._2}}),h=q(function(a,b,c){return{ctor:"_Tuple3",_0:{ctor:"::",_0:a,_1:c._0},_1:c._1,_2:c._2}}),p=n(na,Fc,Q,b);b=Db(Wb,h,e,d,p,c.processes,{ctor:"_Tuple3",_0:{ctor:"[]"},_1:Q,_2:O({ctor:"_Tuple0"})});var r=b._0,w=b._1;return g(x,function(a){return O(g(wb,p,a))},g(x,function(b){return n(vb,a,r,w)},b._2))}),xb=e(function(a,b){return{ctor:"Every",_0:a,_1:b}});e(function(a,
b){return Ic(g(xb,a,b))});var Lc=e(function(a,b){return g(xb,b._0,function(c){return a(b._1(c))})});R.effectManagers.Time={pkg:"elm-lang/core",init:Jc,onEffects:Kc,onSelfMsg:Hc,tag:"sub",subMap:Lc};e(function(a,b){return p.update(b,{expect:g(Ma.mapExpect,a,b.expect)})});da(function(a,b,c,d,e,g,h){return{method:a,headers:b,url:c,body:d,expect:e,timeout:g,withCredentials:h}});var Mc=e(function(a,b){return{ctor:"StringBody",_0:a,_1:b}}),yb=e(function(a,b){return{ctor:"Header",_0:a,_1:b}}),zb=Ma.expectStringResponse,
Pa=function(a){return zb(function(b){return g(mc,a,b.body)})};zb(function(a){return P(a.body)});var Nc={ctor:"EmptyBody"};q(function(a,b,c){return{ctor:"Request",_0:{method:"POST",headers:{ctor:"[]"},url:a,body:b,expect:Pa(c),timeout:J,withCredentials:!1}}});e(function(a,b){return{ctor:"Request",_0:{method:"GET",headers:{ctor:"[]"},url:a,body:Nc,expect:Pa(b),timeout:J,withCredentials:!1}}});var Oc=e(function(a,b){b=g(Ma.toTask,b._0,J);return g(Cc,a,b)});z(function(a,b,c,d){return{url:a,status:b,headers:c,
body:d}});e(function(a,b){return{ctor:"BadPayload",_0:a,_1:b}});e(function(a,b){return{ctor:"StringPart",_0:a,_1:b}});var Pc=y.sleep,Qc=e(function(a,b){a=g(Hb,b-1,a);return"[]"===a.ctor?J:M(a._0)}),Rc=R.outgoingPort("suggest_choice",function(a){return a}),Ab=function(a){return{ctor:"_Tuple2",_0:a,_1:Rc(g(Gb,a.query,g(Qc,a.suggestions,a.focus)))}},Sc=R.incomingPort("search_box_input",ia),Tc=R.incomingPort("search_box_arrow",kb);q(function(a,b,c){return{url:a,public_api_key:b,session_hash:c}});da(function(a,
b,c,d,e,g,h){return{focus:a,public_api_key:b,session_hash:c,url:d,query:e,suggestions:g,queuedChanges:h}});q(function(a,b,c){return{query:a,caret:b,security:c}});var Uc=function(a){return{ctor:"NewSuggestions",_0:a}},Vc=function(a){var b=hc({ctor:"::",_0:{ctor:"_Tuple2",_0:"query",_1:hb(a.query)},_1:{ctor:"::",_0:{ctor:"_Tuple2",_0:"caret_pos",_1:jc(0)},_1:{ctor:"[]"}}});return g(Oc,Uc,{ctor:"Request",_0:{method:"POST",headers:{ctor:"::",_0:g(yb,"X-CS-PubApiKey",a.public_api_key),_1:{ctor:"::",_0:g(yb,
"X-CS-SessionHash",a.session_hash),_1:{ctor:"[]"}}},url:a.url,body:g(Mc,"application/json",g(kc,0,b)),expect:Pa(g(H.decodeContainer,"list",ia)),timeout:J,withCredentials:!1}})},Wc={ctor:"GetSuggestions"},Xc=e(function(a,b){switch(a.ctor){case "SetQuery":return{ctor:"_Tuple2",_0:p.update(b,{query:a._0,queuedChanges:b.queuedChanges+1}),_1:g(Bc,function(a){return Wc},Pc(100))};case "GetSuggestions":return p.eq(b.queuedChanges,1)?{ctor:"_Tuple2",_0:p.update(b,{queuedChanges:b.queuedChanges-1}),_1:Vc(b)}:
{ctor:"_Tuple2",_0:p.update(b,{queuedChanges:b.queuedChanges-1}),_1:sa};case "NewSuggestions":return"Ok"===a._0.ctor?{ctor:"_Tuple2",_0:p.update(b,{suggestions:a._0._0}),_1:sa}:{ctor:"_Tuple2",_0:b,_1:sa};case "Select":return Ab(p.update(b,{focus:a._0}));default:return Ab(p.update(b,{focus:b.focus+a._0}))}}),Yc=function(a){return{ctor:"ArrowKey",_0:a}},Zc=function(a){return{ctor:"SetQuery",_0:a}},Bb=g(ja.programWithFlags,void 0,{init:function(a){return{ctor:"_Tuple2",_0:{focus:0,url:a.url,public_api_key:a.public_api_key,
session_hash:a.session_hash,query:"",suggestions:{ctor:"[]"},queuedChanges:0},_1:sa}},view:function(a){return"[]"===a.suggestions.ctor?La(""):g(tc,{ctor:"[]"},g(Rb,e(function(b,c){return p.eq(b,a.focus-1)?g(rb,{ctor:"::",_0:g(uc,"className","cs_ac_active"),_1:{ctor:"[]"}},{ctor:"::",_0:La(c),_1:{ctor:"[]"}}):g(rb,{ctor:"::",_0:g(sc,"click",ib({ctor:"Select",_0:b+1})),_1:{ctor:"[]"}},{ctor:"::",_0:La(c),_1:{ctor:"[]"}})}),a.suggestions))},update:Xc,subscriptions:function(a){return nb({ctor:"::",_0:Sc(Zc),
_1:{ctor:"::",_0:Tc(Yc),_1:{ctor:"[]"}}})}})(g(Ka,function(a){return g(Ka,function(b){return g(Ka,function(c){return ib({public_api_key:a,session_hash:b,url:c})},g(ra,"url",ia))},g(ra,"session_hash",ia))},g(ra,"public_api_key",ia))),ca={};ca.CurrySearchAutoComplete=ca.CurrySearchAutoComplete||{};"undefined"!==typeof Bb&&Bb(ca.CurrySearchAutoComplete,"CurrySearchAutoComplete",void 0);if("function"===typeof define&&define.amd)define([],function(){return ca});else if("object"===typeof module)module.exports=
ca;else{var Qa=this.Elm;if("undefined"===typeof Qa)this.Elm=ca;else for(var Ca in ca){if(Ca in Qa)throw Error("There are two Elm modules called `"+Ca+"` on this page! Rename one of them.");Qa[Ca]=ca[Ca]}}}).call(this);
